...
(function () {
    ...
    var upyunVisitPath = "http://miz-static.b0.upaiyun.com/";
	var upyunUploadPath = "http://v0.api.upyun.com/";
	var BUCKET = "miz-static";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imageUrl:'http://v0.api.upyun.com/'+BUCKET             //图片上传提交地址
        ,imagePath:upyunVisitPath                    //图片访问地址，引用了fixedImagePath,如有特殊需求，可自行配置        	
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/upyun/imageManager"       //图片在线管理的处理地址
        //,imageManagerPath : upyunVisitPath + saveFolder
